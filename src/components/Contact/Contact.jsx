...
const Contact = () => {
  return (
    <section className="form-section w-full flex flex-col items-center py-10 mt-20 md:px-24 px-2">
      ...
      <form className="w-full grid grid-cols-1 gap-4">
        ...
        <textarea name="message" id="message" placeholder="Tell Us Something..." className="form-inputs col-span-12 md:w-auto w-full h-52 py-4"></textarea>
